class Page < ActiveRecord::Base
  ...
  self.non_versioned_columns += ['title','slug','show_in_header','show_in_footer','foreign_link','position','visible','meta_keywords','meta_description','layout','show_in_sidebar','created_at','updated_at','sidebar_type']
